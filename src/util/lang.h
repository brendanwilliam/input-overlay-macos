...
#define T_BUNDLED_PRESET                T_("Overlay.Preset")
#define T_PROCEDURAL_ENABLED            T_("Overlay.Procedural.Enable")
#define T_PROCEDURAL_SHAPE              T_("Overlay.Procedural.Shape")
#define T_PROCEDURAL_SHAPE_RECTANGLE    T_("Overlay.Procedural.Shape.Rectangle")
#define T_PROCEDURAL_SHAPE_ROUNDED      T_("Overlay.Procedural.Shape.Rounded")
#define T_PROCEDURAL_SHAPE_PILL         T_("Overlay.Procedural.Shape.Pill")
#define T_PROCEDURAL_KEY_WIDTH          T_("Overlay.Procedural.KeyWidth")
#define T_PROCEDURAL_KEY_HEIGHT         T_("Overlay.Procedural.KeyHeight")
#define T_PROCEDURAL_GAP                T_("Overlay.Procedural.Gap")
#define T_PROCEDURAL_RADIUS             T_("Overlay.Procedural.Radius")
#define T_PROCEDURAL_FONT               T_("Overlay.Procedural.Font")
#define T_PROCEDURAL_FONT_SIZE          T_("Overlay.Procedural.FontSize")
#define T_PROCEDURAL_FILL_COLOR         T_("Overlay.Procedural.FillColor")
...
#define T_PROCEDURAL_MOUSE_ENABLED      T_("Overlay.Procedural.Mouse.Enable")
#define T_PROCEDURAL_MOUSE_WIDTH        T_("Overlay.Procedural.Mouse.Width")
#define T_PROCEDURAL_MOUSE_HEIGHT       T_("Overlay.Procedural.Mouse.Height")
#define T_PROCEDURAL_MOUSE_GAP          T_("Overlay.Procedural.Mouse.Gap")
#define T_PROCEDURAL_MOUSE_RADIUS       T_("Overlay.Procedural.Mouse.Radius")
#define T_PROCEDURAL_MOUSE_FONT         T_("Overlay.Procedural.Mouse.Font")
#define T_PROCEDURAL_MOUSE_FONT_SIZE    T_("Overlay.Procedural.Mouse.FontSize")
#define T_PROCEDURAL_MOUSE_FILL_COLOR   T_("Overlay.Procedural.Mouse.FillColor")
#define T_PROCEDURAL_MOUSE_PRESSED_COLOR T_("Overlay.Procedural.Mouse.PressedColor")
#define T_PROCEDURAL_MOUSE_BORDER_COLOR T_("Overlay.Procedural.Mouse.BorderColor")
#define T_PROCEDURAL_MOUSE_TEXT_COLOR   T_("Overlay.Procedural.Mouse.TextColor")
#define T_PROCEDURAL_MOUSE_LEFT_LABEL   T_("Overlay.Procedural.Mouse.LeftLabel")
#define T_PROCEDURAL_MOUSE_RIGHT_LABEL  T_("Overlay.Procedural.Mouse.RightLabel")
#define T_PROCEDURAL_MOUSE_MIDDLE_LABEL T_("Overlay.Procedural.Mouse.MiddleLabel")
